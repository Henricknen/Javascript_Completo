class Cxmsg {
    static cor = "#888";        // iniçiando propriedade cor com uma cor 'fixa'
    static destino = null;
    static divmsg = null;

    static config = (config)=> {        // método 'config' reçebe as 'configurações' da caixa
        this.cor = config.cor;
    }
...
export {Cxmsg};     // exportando a classe 'Cxmsg' para ser utilizada com 'módulo'