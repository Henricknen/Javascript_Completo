class Carro {      // classe Carro
    ...
    setNome(nome) {     // método 'setNome' atribui um novo nome para propriedade nome
        this.nome = nome;
    }
...
c4.setNome("Blidado");      // chamando o método 'setNome' que irá setar ou seja alterar o nome da propriedade c4, que passará a ser chamado de 'Blindado'
c4.setVelMax(300);
